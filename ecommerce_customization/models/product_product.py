...
class ProductProduct(models.Model):
    ...
    allowed_preorder_qty = fields.Float(string='Allow preorder when quantity Less then or Equal', related='product_tmpl_id.allowed_preorder_qty')
...
class ProductTemplate(models.Model):
    ...
    def _get_combination_info(self, combination=False, product_id=False, add_qty=1, pricelist=False, parent_combination=False, only_template=False):
        ...
        combination_info['product_quant'] = self.env['product.template'].sudo().browse(combination_info['product_template_id']).qty_available
